<%@ Page Title="Register" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="Register.aspx.cs" Inherits="WebClient.Account.Register" %>
                ...
                <ContentTemplate>
                    ...
                    <div class="accountInfo">
                        <fieldset class="register">
                            ...
                            <p>
                                <asp:Label ID="Label1" runat="server" AssociatedControlID="ConfirmPassword">Licence Number:</asp:Label>
                                <asp:TextBox ID="LicenceNumber" runat="server" CssClass="textEntry"></asp:TextBox>
                            </p>
                            <p>
                                <asp:Label ID="Label2" runat="server" AssociatedControlID="ConfirmPassword">Address:</asp:Label>
